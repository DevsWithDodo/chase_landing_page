...
export const metadata: Metadata = {
  ...
  keywords: ['JetLag alternative', 'Hide and seek', 'Hide & Seek', 'real-world chase game', 'real Scotland Yard game', 'Mister X game', 'Mr. X game', 'city exploration game', 'urban adventure', 'location-based game', 'free chase game', 'real-time tracking game', 'public transit game', 'IRL game', 'treasure hunt'],
